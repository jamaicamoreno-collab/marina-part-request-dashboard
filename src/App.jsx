                ...
                <div style={{display:"flex",gap:11,alignItems:"flex-start"}}>
                  ...
                  <div style={{flex:1,minWidth:0}}>
                    <div style={{display:"flex",alignItems:"center",gap:7,flexWrap:"wrap",marginBottom:5}}>
                      ...
                      <a href={req.d365Url} target="_blank" rel="noopener noreferrer" style={{fontSize:11,color:"#185FA5",background:"#E6F1FB",padding:"2px 8px",borderRadius:5,fontFamily:"monospace",textDecoration:"none",border:"0.5px solid #B5D4F4",display:"inline-flex",alignItems:"center",gap:4}}>{req.id} ↗</a>
